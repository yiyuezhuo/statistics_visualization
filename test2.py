# -*- coding: utf-8 -*-
"""
Created on Sun Dec 31 00:06:35 2017
...
print('calling ffmpeg to merge frames to video')
    
os.system('ffmpeg -r 60 -f image2 -s 1920x1080 -i cache2/%010d.png -vcodec libx264 -crf 25  -pix_fmt yuv420p test.mp4')

print('success, deleting temp files...')
